import { Home, Trophy, Laptop, Mic, Caravan, UserCircle } from "lucide-react"; 
...
export const Header: React.FC = () => { 
 ...
 const menuItems = [ 
   ...
   { label: "Seminar", href: "/seminar", icon: <Caravan size={18} /> }, 
 ...
 return ( 
   <header className=" bg-white shadow-sm px-6 py-2"> 
     <div className="max-w-7xl mx-auto flex justify-between items-center gap-4"> 
      ...
      to ={item.href} 
      className={({isActive}) => `flex items-center gap-2 px-4 py-2 font-medium transition-all 
      duration-200 ${ 
